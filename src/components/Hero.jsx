    ...
    <section id='home' className={`flex flex-col md:flex-row ${styles.paddingY}`} >
      <div className={`flex-1 flex-col ${styles.flexStart} xl:px-0 sm:px-16 px-6`} >
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          <h1 className='flex-1 text-white font-semibold font-poppins ss:text-[72px] text-[54px] ss:leading-[100px] leading-[80px]'>
          ...
          <h1 className='text-white font-semibold font-poppins ss:text-[68px] text-[52px] ss:leading-[100px] leading-[80px] w-full'>Payment Method</h1>
      ...
      <div className={`flex flex-1 ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt="biling" className='w-full h-full relative z-[5]'/>
